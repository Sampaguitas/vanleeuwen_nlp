...
workbook.xlsx.readFile('./generate/dimensions/BW FITTINGS/ELB 90 LR/elb90Lr.xlsx')
.then(wb => {
  ...
  fs.writeFile('./generate/dimensions/BW FITTINGS/ELB 90 LR/elb90Lr.json', JSON.stringify(myCollection), function(err) {
    if (err) {
      console.log(err);
    } else {
      console.log('success');
