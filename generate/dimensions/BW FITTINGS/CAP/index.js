...
workbook.xlsx.readFile('./generate/dimensions/BW FITTINGS/CAP/cap.xlsx')
.then(wb => {
  ...
  fs.writeFile('./generate/dimensions/BW FITTINGS/CAP/cap.json', JSON.stringify(myCollection), function(err) {
    if (err) {
      console.log(err);
    } else {
      console.log('success');
