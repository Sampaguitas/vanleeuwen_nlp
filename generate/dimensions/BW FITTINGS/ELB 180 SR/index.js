...
workbook.xlsx.readFile('./generate/dimensions/BW FITTINGS/ELB 180 SR/elb180Sr.xlsx')
.then(wb => {
  ...
  for (let row = 2; row < rowCount +1 ; row++) {
    ...
    let myObject = {
      ...
      'dimensions': {
        ...
        'centerToCenter': {
          'display': 'center to center dimension',
          'imperial': {
        ...
        'backToFace': {
          'display': 'back to face dimension',
          'imperial': {
        ...
        'centerToMiddle': {
          'display': 'center to middle dimension',
          'imperial': {
  ...
  fs.writeFile('./generate/dimensions/BW FITTINGS/ELB 180 SR/elb180Sr.json', JSON.stringify(myCollection), function(err) {
    if (err) {
      console.log(err);
    } else {
      console.log('success');
