...
workbook.xlsx.readFile('./generate/dimensions/BW FITTINGS/ELB 180 LR/elb180Lr.xlsx')
.then(wb => {
  ...
  fs.writeFile('./generate/dimensions/BW FITTINGS/ELB 180 LR/elb180Lr.json', JSON.stringify(myCollection), function(err) {
    if (err) {
      console.log(err);
    } else {
      console.log('success');
