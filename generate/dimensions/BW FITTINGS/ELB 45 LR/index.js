...
workbook.xlsx.readFile('./generate/dimensions/BW FITTINGS/ELB 45 LR/elb45Lr.xlsx')
.then(wb => {
  ...
  fs.writeFile('./generate/dimensions/BW FITTINGS/ELB 45 LR/elb45Lr.json', JSON.stringify(myCollection), function(err) {
    if (err) {
      console.log(err);
    } else {
      console.log('success');
